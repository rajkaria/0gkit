/**
 * prediction-market — chat adapter (Next.js App Router)
 *
 * Identical route contract to the react-app adapter.
 * chat is a Next.js base — same App Router routes, same pattern.
 *
 * Routes:
 ...
 * Composition wiring
 * ───────────────────
 * This kit COMPOSES ai-oracle. lib/oracle.ts (placed by the composition engine
 * from ai-oracle) and lib/market.ts both coexist in the applied project.
 * This adapter imports resolveOracle from the co-located oracle lib.
 *
